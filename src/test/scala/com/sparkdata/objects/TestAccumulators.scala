package com.sparkdata.objects

import com.sparkdata.objects.{Accumulators, CopyActionResult, DeleteActionResult, DeleteResult, DirectoryCopyResult, DistCPResult, FileCopyResult}
