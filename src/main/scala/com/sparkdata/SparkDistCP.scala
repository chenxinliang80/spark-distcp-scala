...
import java.net.URI
import com.sparkdata.objects.{Accumulators, ConfigSerDeser, CopyDefinitionWithDependencies, CopyPartitioner, DistCPResult, FileSystemObjectCacher, Logging}
import com.sparkdata.utils.{CopyUtils, FileListUtils, PathUtils}
...
object SparkDistCP extends Logging {
  ...
  /**
    ...
    */
  private[sparkdata] def doCopy(sourceRDD: RDD[CopyDefinitionWithDependencies], accumulators: Accumulators, options: SparkDistCPOptions): RDD[DistCPResult] = {
  ...
  /**
    ...
    */
  private[sparkdata] def doDelete(destRDD: RDD[URI], accumulators: Accumulators, options: SparkDistCPOptions): RDD[DistCPResult] = {
  ...
  /**
    ...
    */
  private[sparkdata] implicit class DistCPIteratorImplicit[B](iterator: Iterator[B]) {
  ...
  /**
    ...
    */
  private[sparkdata] def batchAndPartitionFiles(rdd: RDD[CopyDefinitionWithDependencies], maxFilesPerTask: Int, maxBytesPerTask: Long): RDD[((Int, Int), CopyDefinitionWithDependencies)] = {
  ...
  /**
    ...
    */
  private[sparkdata] def generateBatchedFileKeys(maxFilesPerTask: Int, maxBytesPerTask: Long): (Int, Iterator[CopyDefinitionWithDependencies]) => Iterator[((Int, Int), CopyDefinitionWithDependencies)] = {
    (partition, iterator) =>
